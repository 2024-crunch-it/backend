...
public class UserSubscriptionLikeController {
    ...
    @PostMapping
    public ResponseEntity<?> addLike(@Parameter(description = "사용자 ID") @RequestParam(name = "userId") Long userId,
                                     @Parameter(description = "공고 번호") @RequestParam(name = "pblancNo") String pblancNo,
                                     @Parameter(description = "주택 관리 번호") @RequestParam(name = "houseManageNo") String houseManageNo) {
    ...
    @DeleteMapping
    public void removeLike(@Parameter(description = "사용자 ID") @RequestParam(name = "userId") Long userId,
                           @Parameter(description = "공고 번호") @RequestParam(name = "pblancNo") String pblancNo,
                           @Parameter(description = "주택 관리 번호") @RequestParam(name = "houseManageNo") String houseManageNo) {
    ...
    @GetMapping("/user")
    public List<UserSubscriptionLikeResponseDto> getAllLikesByUser(@Parameter(description = "사용자 ID") @RequestParam(name = "userId") Long userId) {
